...
class BenExpressionViewHolder(itemView: View, itemClickListener: MessageListItemClickListener?) :
    ...
    companion object {
        fun create(
            ...
            return BenExpressionViewHolder(
                BenChatRowBigExpression(parent.context, isSender),
                itemClickListener
            )
        }
    }
