...
class BenChatRowVoice : BenChatRowFile {
    ...
    override fun onInflateView() {
        inflater.inflate(
            if (!isSender) R.layout.ben_row_received_voice else R.layout.ben_row_sent_voice,
            this
        )
    }
    ...
    override fun onSetUpView() {
        ...
        if (!isSender) {
            voiceImageView!!.setImageResource(R.drawable.ben_chatfrom_voice_playing)
            voiceLengthView!!.setPadding(padding, 0, 0, 0)
        } else {
            voiceImageView!!.setImageResource(R.drawable.ben_chatto_voice_playing)
    ...
    companion object {
        private val TAG = BenChatRowVoice::class.java.simpleName
    }
}