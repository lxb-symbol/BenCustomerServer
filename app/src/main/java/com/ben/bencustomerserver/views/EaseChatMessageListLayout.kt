    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            textColor = if (textColorRes != -1) {
                ...
                a.getColor(R.styleable.EaseChatMessageListLayout_ease_chat_item_text_color, 0)
            }
            val itemMinHeight =
            ...
            timeTextColor = if (timeTextColorRes != -1) {
                ...
                a.getColor(R.styleable.EaseChatMessageListLayout_ease_chat_item_time_text_color, 0)
            }
