...
//            message.setAttribute(BenConstant.MESSAGE_ATTR_EXPRESSION_ID, identityCode)
//        }
//        message.setAttribute(BenConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, true)
        return message
    }
...
//                val userProvider: BenUserProfileProvider = BenIM.getInstance().getUserProvider()
//                var from: String = message.getFrom()
//                if (userProvider != null && userProvider.getUser(from) != null) {
//                    val user: BenUser = userProvider.getUser(from)
...
//    }
     ...
     * @param user
     */
//    fun setUserInitialLetter(user: BenUser) {
//        val DefaultLetter = "#"
...
//        return if (chatType == BenConstant.CHATTYPE_SINGLE) {
//            EMConversationType.Chat
//        } else if (chatType == BenConstant.CHATTYPE_GROUP) {
...
//                BenConstant.CHATTYPE_CHATROOM
//            } else {
//                BenConstant.CHATTYPE_GROUP
//            }
//        } else {
//            BenConstant.CHATTYPE_SINGLE
//        }
//    }
