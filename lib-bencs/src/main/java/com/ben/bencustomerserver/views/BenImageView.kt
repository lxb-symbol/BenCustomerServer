...
class BenImageView : AppCompatImageView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        // get attribute of BenImageView
        if (attrs != null) {
            val array = context.obtainStyledAttributes(attrs, R.styleable.BenImageView)
            borderColor = array.getColor(R.styleable.BenImageView_ben_border_color, borderColor)
            borderWidth = array.getDimensionPixelOffset(
                R.styleable.BenImageView_ben_border_width,
                borderWidth
            )
            pressAlpha = array.getInteger(R.styleable.BenImageView_ben_press_alpha, pressAlpha)
            pressColor = array.getColor(R.styleable.BenImageView_ben_press_color, pressColor)
            radius = array.getDimensionPixelOffset(R.styleable.BenImageView_ben_radius, radius)
            shapeType = array.getInteger(R.styleable.BenImageView_ben_shape_type, shapeType)
            array.recycle()
        }
