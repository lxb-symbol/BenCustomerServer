...
class BenMessageAdapter : BenBaseDelegateAdapter<BaseMessageModel>() {
     ...
     * @return
     */
    override fun addDelegate(delegate: com.ben.bencustomerserver.adapter.BenAdapterDelegate<*, *>): BenBaseDelegateAdapter<*> {
        var clone: com.ben.bencustomerserver.adapter.BenAdapterDelegate<*, *>? = null
        try {
            clone = delegate.clone() as com.ben.bencustomerserver.adapter.BenAdapterDelegate<*, *>
    ...
    override fun setFallbackDelegate(delegate: com.ben.bencustomerserver.adapter.BenAdapterDelegate<Any, ViewHolder<*>>?): BenBaseDelegateAdapter<*> {
        var clone: com.ben.bencustomerserver.adapter.BenAdapterDelegate<Any, ViewHolder<*>>? = null
        try {
            clone = delegate?.clone() as com.ben.bencustomerserver.adapter.BenAdapterDelegate<Any, ViewHolder<*>>
            clone.tag = (Direct.RECEIEVE.name)
            clone.tags.add(Direct.RECEIEVE.name)
